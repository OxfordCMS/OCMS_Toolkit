...
def find_failed_samples(infile, outfiles):
    ...
    # List of QC metric columns — adjust index range if your MultiQC version changes
...
@merge(find_failed_samples, "multiqc_data/failed_qc_metrics/failed_combined_samples.txt")
